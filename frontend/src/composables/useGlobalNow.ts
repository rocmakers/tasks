 ...
 *
 * Do not register Vue Router lifecycle hooks here: formatDateSince can initialise
 * this during render, and onBeforeRouteUpdate outside of setup becomes a Vue warning toast.
 */
